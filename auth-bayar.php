...
<body>
	<header>
		...
		<h1>Gabus 2023</h1>
		<ul>
			<li><a href="auth.php?peserta=<?php echo $id ?>" class="pilih">Beranda</a></li>
	...
	<section class="content">
			...
			<div class="box">
				<br>
				<h2 align="center">Tagihan anda sebesar Rp<?php echo number_format($b->price); ?>.-</h2>
				<h4 align="center">Pastikan anda sudah membayar sebelum melakukan konfirmasi pembayaran</h4><br>
				<center><h5>Jika Anda Mempunyai Voucher <a class="det" href="auth-voc.php?peserta=<?php echo $id ?>">Gunakan Voucher</a></h5></center>
				<br>
			</div>
